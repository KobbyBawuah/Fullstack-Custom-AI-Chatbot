...
export default function Home() {
  ...
  const [previous_questions_and_answers, setPreviousQuestionsAndAnswers] =
    useState("");
      ...
      <section className="flex flex-col gap-2 py-10">
        ...
        <div className="container">
          ...
          <div className="flex justify-between mt-4">
            ...
            <Button
              className=" mt-4 mb-4"
              onClick={createIndexAndEmbeddingslocally}
            ...
            >
              Ask your already created Knowledge base
            </Button>
            <Button className=" mt-4 mb-4" onClick={deleteOpenAiKnowledgebase}>
              Delete OpenAI Knowledge base
            </Button>
            <Button className=" mt-4 mb-4" onClick={deletelocalKnowledgebase}>
              Delete Local Knowledge base
            </Button>
          </div>
        ...
        <div
          className="container"
          style={{ display: trained ? "block" : "none" }}
        >
          {/* <div className='container'> */}
